...
public class MailService {
	 ...
	 */
	public MailService(String smtpServer, String from, String displayName, String to,
	...
	public HashMap<String, String> send() {
		...
		props.put("mail.smtp.port", "25");//腾讯企业邮箱
		//props.put("mail.smtp.port", "587");//瑞能邮箱office365
		props.put("mail.smtp.starttls.enable","true");//瑞能邮箱office365
		if (ifAuth) { // 服务器需要身份认证
