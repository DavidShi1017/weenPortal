 ...
 *
 */
public class ExpensesTotal extends SearchInfo{

	private static final long serialVersionUID = 8439042050053296566L;
	
	private Long expenses_total_id;			//计划Id
	private String transaction_id;	//事务Id
	
	private Long org_id;			//提交人部门Id
	private String org_name;		//提交人部门
	
	private String user_id;	//收款人/出差人
	private String user_name;// 收款单位
	
	private Long cost_org_id;//费用承担部门
	private String cost_org_name;

	private String pay_type;	//支付方式
	
	private BigDecimal total_money;	//报销总金额
	private BigDecimal audit_money; //审核总金额
	
	private String cost_center;		//成本中心
	private String cost_center_name;//成本中心名字
	private String cost_center_type;//成本中心类型
	private String has_play_money;	//是否打款		

	private String memo;			//备注
	private String plan_flag;		//删除标记
	...
	private String pay_ee;// 收款人
	private String pay_account;// 收款人账号
	private String financial_doc_num;// 会计凭证号
	private String auditor;
	private String flag;
	private String write_eventId; //核销的事务ID
	private String write_status; //核销状态
	private String travel_eventId; //出差的事务ID
	private String travleName; //出差申请标题
	private String applayMoney; //出差申请金额
	private String  payCash;
	private String  chouQian;

	private List<ExpensesDetail> detailList;
	...
	public List<ExpensesDetail> getDetailList() {
		return detailList;
	}

	public void setDetailList(List<ExpensesDetail> detailList) {
	...
	public String getWrite_eventId() {
		return write_eventId;
	}

	public void setWrite_eventId(String write_eventId) {
		this.write_eventId = write_eventId;
	}
	...
	public String getTravel_eventId() {
		return travel_eventId;
	}

	public void setTravel_eventId(String travel_eventId) {
		this.travel_eventId = travel_eventId;
	}
	...
	public String getChouQian() {
		return chouQian;
	}

	public void setChouQian(String chouQian) {
