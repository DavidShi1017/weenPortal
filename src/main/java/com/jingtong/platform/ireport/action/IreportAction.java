package com.jingtong.platform.ireport.action;
...
import com.jingtong.platform.ireport.service.impl.ReportServiceImpl;
import com.jingtong.platform.ireport.util.IreportUtil;
import com.jingtong.platform.ireport.util.JDBCConnection;
		...
		if(returnmodle!=null){
			...
			if(jasperPrint!=null){
				...
				if(returnmodle.getIs_pagination()!=null&&returnmodle.getIs_pagination().equals("1")){
					...
					htmlExporter.setParameter(JRExporterParameter.PAGE_INDEX,pageIndex-1);
					/**
					 * 获取总页数
					 */				
