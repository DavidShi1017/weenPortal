...
public class KunnrAcount extends SearchInfo {
	...
	private String typeB_text; // 季返非固定
	private String typeC_text; // 年返非固定
	...
	public String getTypeB_text() {
		return typeB_text;
	}

	public void setTypeB_text(String typeB_text) {
		this.typeB_text = typeB_text;
	}

	public String getTypeC_text() {
		return typeC_text;
	}

	public void setTypeC_text(String typeC_text) {
		this.typeC_text = typeC_text;
	}
}
