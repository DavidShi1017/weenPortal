...
function loadGrid(){
	...
	$("#datagrid").datagrid({
		columns:[[
		   			...
		   			{field:'KUNNM',title:'客户描述',width:200,align:'center'},
//					{field:'KUNNR_TEL',title:'电话',width:100,align:'center'},
		   			{field:'BZIRK_TXT',title:'大区',width:100,align:'center'},
		   			{field:'VKBUR_TXT',title:'市场部',width:80,align:'center'},
		   			{field:'VKGRP_TXT',title:'片区',width:80,align:'center'},
		   			{field:'STATE1',title:'库存上报',width:60,align:'center',formatter:function(v){return getStateValue(v,"stock");}},
		   			{field:'STATE2',title:'需求上报',width:60,align:'center',formatter:function(v){return getStateValue(v,"plan");}},
		   			{field:'CRDAT',title:'上报时间',width:80,align:'center'},
		   			{field:'AUSTA',title:'片区审核',width:60,align:'center',formatter:function(v){return getAuditValue(v,"vkgrp");}},
		   			{field:'AUTIM',title:'审核时间',width:80,align:'center'},
		   			{field:'AUSTA1',title:'市场部审核',width:60,align:'center',formatter:function(v){return getAuditValue(v,"vkbur");}},
		   			{field:'AUTIM1',title:'审核时间',width:80,align:'center'},
		   			{field:'AUSTA2',title:'大区审核',width:60,align:'center',formatter:function(v){return getAuditValue(v,"bzirk");}},
		   			{field:'AUTIM2',title:'审核时间',width:80,align:'center'}
		 ]],
		method: 'get',
		singleSelect: true,
		border:false,
		fit:true,
		rownumbers: true,
		url:appUrl+ '/inOutReportAction!getSubmitReportJson.jspa?ran='+Math.random(),
		queryParams: {bzirk:bzirk,vkbur:vkbur,vkgrp:vkgrp}
	});
}
...
function gridMix(){
	var date1 = $("#rpmnt1").val();
	var date2 = $("#rpmnt2").val();
...
function getAuditValue(value,type){
	if(type=="vkgrp"){
		if(value>0){
...
function exportExcel(){
	...
	form.action = appUrl + '/inOutReportAction!exportSubmitReport.jspa?bzirk='+bzirk+'&vkbur='+vkbur+"&vkgrp="+vkgrp;
