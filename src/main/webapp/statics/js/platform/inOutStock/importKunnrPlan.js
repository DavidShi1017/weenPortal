...
function importData(){
	...
	form.action = appUrl + "/inOutStockAction!saveImportKunnrPlan.jspa?kunnr="+kunnr+"&datid="+datid;
	form.submit();	
}
...
function downloadExcel(){
	...
	var datid=$('#hdDatid').val();
	var form = window.document.forms[0];
	form.action = appUrl + '/inOutStockAction!exportKunnrPlan.jspa?kunnr='+kunnr+'&datid='+datid;
