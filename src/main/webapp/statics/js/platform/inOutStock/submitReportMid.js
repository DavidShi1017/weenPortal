...
function loadGrid(){
	...
	$("#datagrid").datagrid({
		...
		fit:true,
		rownumbers: true,
		url:appUrl+ '/inOutReportAction!getSubmitReportJsonMid.jspa?ran='+Math.random(),
...
function exportExcel(){
	...
	form.action = appUrl + '/inOutReportAction!exportSubmitReportMid.jspa?bzirk='+bzirk+'&vkbur='+vkbur+"&vkgrp="+vkgrp;
