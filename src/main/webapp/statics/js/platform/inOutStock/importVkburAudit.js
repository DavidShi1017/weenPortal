...
function importData(){
	...
	form.action = appUrl + "/inOutStockAction!saveImportVkburAudit.jspa?bzirk="+bzirk+"&vkbur="+vkbur+"&datid="+datid;
	form.submit();	
}
...
function downloadExcel(){
	...
	var datid=$('#hdDatid').val();
	var form = window.document.forms[0];
	form.action = appUrl + '/inOutStockAction!exportVkburAudit.jspa?vkbur='+vkbur+'&datid='+datid;
