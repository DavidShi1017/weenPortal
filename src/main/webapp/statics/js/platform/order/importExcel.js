...
function importData(){
		...
		form.action = appUrl + "/orderAction!findOrderExcel.jspa?path="+encodeURIComponent($('#uploadFile').val())+'&currency_code='+$('#currency_code').val()+'&office_id='+$('#office_id').val()+'&customer_id='+$('#customer_id').val();
		form.submit();
}
