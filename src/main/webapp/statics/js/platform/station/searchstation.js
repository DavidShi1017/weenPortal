...
// 创建窗口对象
function initMaintStation(title, url, WWidth, WHeight,left,top) {
	var url = appUrl + url;
...
function createStation() {
	initMaintStation('创建岗位', '/station!createStationPagePre.jspa', 500, 300,200,50);
}
...
function getByStation(name, id) {
	initMaintStation('查看人员',
			"/station!configStationUserPagePre.jspa?stationId=" + id
					+ "&&stationName=" + name, 900, 400,100,50);
}
